...
# Data parameters
parser.add_argument("--custom_image_path", type=str, default=None, help="path to own dataset of JPEG images | if not specified SVHN will be downloaded and used.")
parser.add_argument("--image_size", type=int, default=65, help="height and width of image | image will be rescaled to that size")
...
parser.add_argument("--conv_dim", type=int, default=32, help="output dimension of the first convolutional layer | increases by the factor of 2")
# Training parameters
...
##### Models #####
D = Discriminator(conv_dim=opt.conv_dim)
G = Generator(conv_dim=opt.conv_dim, z_dim=opt.z_size)
